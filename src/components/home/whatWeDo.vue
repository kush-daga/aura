        ...
        <v-layout wrap align-center justify-center row fill-height>
            <v-flex xs12 md3 lg3 class="pa-2">
                ...
                <p class="google-font" style="font-size:110%">
                    DSCs are for student developers who are interested in
            ...
            <v-flex xs12 md9 lg9 class="">
                <v-layout row wrap>
                    <v-flex xs6 sm6 md3 lg3 class="text-xs-center pa-2">
                        <v-icon large style="font-size:300%"
                            >chat_bubble</v-icon
                        >
                    ...
                    <v-flex xs6 sm6 md3 lg3 class="text-xs-center pa-2">
                        ...
                        <p class="google-font" style="font-size:110%">
                            Get hands-on experience and guidance from the
                            community members
                        </p>
                    </v-flex>
                    ...
                    <v-flex xs6 sm6 md3 lg3 class="text-xs-center pa-2">
                        ...
                        <p class="google-font" style="font-size:110%">
                            Workshops on differet topics and new technologies
                            open for all!
                        </p>
                    </v-flex>
